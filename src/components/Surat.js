...
const Surat = () => {
  return (
    <div
      className="relative h-[100vh] flex flex-col justify-center items-center text-center p-10 mt-16 space-y-5 "
      style={{ backgroundImage: "url(/img/bg.jpg)" }}
    >
      <svg
        xmlns="http://www.w3.org/2000/svg"
        viewBox="0 0 283.5 27.8"
        className="w-[244%] h-[144px] top-0 absolute left-1/2 translate-x-[-50%] z-0 m-[-20px]"
      ...
      <img
        className="z-10 absolute top-0 left-1/2 translate-x-[-50%] w-[80%] max-w-sm"
        src="/img/floral.png"
        alt=""
      />
      <h5 className="text-3xl">-Surat Ar-Rum : 21-</h5>
      ...
      <img
        className="z-10 absolute bottom-0 left-1/2 translate-x-[-50%] w-[80%] max-w-sm"
        src="https://galipatstory.com/wp-content/uploads/2020/12/FLORAL-3.png"
        alt=""
      />
      <svg
        xmlns="http://www.w3.org/2000/svg"
        viewBox="0 0 283.5 27.8"
        className="w-[244%] h-[144px] bottom-0 absolute left-1/2 translate-x-[-50%] rotate-180 z-0"
        preserveAspectRatio="none"
      >
        <path
          className="fill-white"
