...
import img1 from "../assets/cici (1).webp";
import img2 from "../assets/cici (2).jpg";
import img3 from "../assets/cici (3).jpg";
import img4 from "../assets/cici (4).webp";
import img5 from "../assets/cici (5).jpg";
import img6 from "../assets/cici (6).jpg";

const Galeri = () => {
  return (
    <div className="text-center relative my-10">
      <div className="relative">
        <div className="absolute z-10 left-1/2 translate-x-[-50%] w-max">
          <h5 className="text-4xl text-color1 font-raleway">GALERI</h5>
          <h5
            data-aos="slide-up"
            className="text-4xl font-sacramento text-red-500"
          >
            Kenangan Kami
          </h5>
        </div>
        {/* <!-- className="w-[144%]   top-[-11%] absolute left-[-40%] rotate-180 z-0" --> */}
        <svg
          xmlns="http://www.w3.org/2000/svg"
          viewBox="0 0 283.5 27.8"
          className="w-[144%]  rotate-180 relative left-[-40%]"
        ...
        <div className="bg-red-50">
          <div className="grid grid-cols-2 gap-3  px-5 pb-10 pt-20 max-w-lg m-auto">
            <div data-aos="zoom-in-right">
              <img className="transition-all object-cover" src={img1} alt="" />
            </div>
            <div data-aos="zoom-in-left">
              <img className="transition-all object-cover" src={img2} alt="" />
            </div>
            <div data-aos="zoom-in-right">
              <img className="transition-all object-cover" src={img3} alt="" />
            </div>
            <div data-aos="zoom-in-left">
              <img className="transition-all object-cover" src={img4} alt="" />
            </div>
            <div data-aos="zoom-in-right">
              <img className="transition-all object-cover" src={img5} alt="" />
            </div>
            <div data-aos="zoom-in-left">
              <img className="transition-all object-cover" src={img6} alt="" />
            </div>
          </div>
        </div>
        {/* <!-- className="w-[144%]   bottom-[-10%] absolute left-1/2 translate-x-[-50%] z-0" --> */}
        <svg
          xmlns="http://www.w3.org/2000/svg"
          viewBox="0 0 283.5 27.8"
          className="w-[144%]  translate-x-[-50%] relative left-1/2"
          preserveAspectRatio="none"
        >
          <path
            className="fill-red-50"
