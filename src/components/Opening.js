  ...
  return (
    <div className="relative">
      ...
      <svg
        ...
        className="w-[244%] h-[104px] top-full absolute left-1/2 translate-x-[-50%] rotate-180"
      ...
      <div
        className="opacity-50 bg-[length:400vh] md:bg-[length:200vw] bg-center bg-top bg-no-repeat absolute top-0 left-0 h-full w-full "
        style={{ backgroundImage: "url(/img/ornament.png)" }}
      ></div>
      <div className="relative z-20 text-center h-[100vh] flex flex-col items-center justify-center p-14">
        <p className="text-2xl text-gray-700 max-w-lg">
          Kami mengundang Bapak/Ibu/Saudara/i untuk menghadiri pernikahan kami
        </p>
        <h1 className="text-[9rem] font-euphoria text-color1">Aji</h1>
        <h4 className="text-2xl text-color1">——— dan ———</h4>
        <h1 className="text-[9rem] font-euphoria text-color1">Nike</h1>
        <h4 className="text-2xl">Sabtu, 04 Juni 2022</h4>
      </div>
    </div>
  );
};
